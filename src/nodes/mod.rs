...
pub fn catalog() -> Vec<NodeCatalogEntry> {
    vec![
        ...
        NodeCatalogEntry { wip: false, singleton: false, label: "OB Wheel", category: "Hardware",
            factory: || NodeType::ObEncoder { device_id: 1, hub_node_id: 0, label_color: [255, 255, 255], port_name: String::new(), selected_port: String::new() } },
        ...
        NodeCatalogEntry { wip: false, singleton: false, label: "OB Pressure", category: "Hardware",
            factory: || NodeType::ObPressure { device_id: 1, hub_node_id: 0, label_color: [255, 255, 255], port_name: String::new(), selected_port: String::new() } },
        NodeCatalogEntry { wip: false, singleton: false, label: "OB Distance", category: "Hardware",
            factory: || NodeType::ObDistance { device_id: 1, hub_node_id: 0, label_color: [255, 255, 255], port_name: String::new(), selected_port: String::new() } },
        NodeCatalogEntry { wip: false, singleton: false, label: "OB Knob", category: "Hardware",
            factory: || NodeType::ObKnob { device_id: 1, hub_node_id: 0, label_color: [255, 255, 255], port_name: String::new(), selected_port: String::new() } },
        ...
        NodeCatalogEntry { wip: false, singleton: false, label: "OB LED Strip", category: "Hardware",
            factory: || NodeType::ObLight { device_id: 1, hub_node_id: 0, mode: 0, color: [255, 180, 100], brightness: 0.20, position: 0.5, speed: 0.5, color_mode: 0, send_mode: 0, num_leds: 100, port_name: String::new(), selected_port: String::new() } },
